...
Public Class bc_am_workflow_container_frm
    ...
    Friend WithEvents uxDocumentSource As System.Windows.Forms.GroupBox
    Friend WithEvents uxLocal As System.Windows.Forms.RadioButton
    Friend WithEvents uxCentral As System.Windows.Forms.RadioButton
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.uxDocumentSource = New System.Windows.Forms.GroupBox
        Me.uxLocal = New System.Windows.Forms.RadioButton
        Me.uxCentral = New System.Windows.Forms.RadioButton
        ...
        Me.uxDocumentSource.SuspendLayout()
        ...
        Me.FilterPanel.Controls.Add(Me.uxDocumentSource)
        ...
        'uxDocumentSource
        '
        Me.uxDocumentSource.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.uxDocumentSource.Controls.Add(Me.uxLocal)
        Me.uxDocumentSource.Controls.Add(Me.uxCentral)
        Me.uxDocumentSource.Location = New System.Drawing.Point(768, 74)
        Me.uxDocumentSource.Margin = New System.Windows.Forms.Padding(3, 0, 0, 3)
        Me.uxDocumentSource.Name = "uxDocumentSource"
        Me.uxDocumentSource.Padding = New System.Windows.Forms.Padding(0)
        Me.uxDocumentSource.Size = New System.Drawing.Size(257, 46)
        Me.uxDocumentSource.TabIndex = 24
        Me.uxDocumentSource.TabStop = False
        Me.uxDocumentSource.Text = "Document Source"
        '
        'uxLocal
        '
        Me.uxLocal.AutoSize = True
        Me.uxLocal.Font = New System.Drawing.Font("Verdana", 7.25!)
        Me.uxLocal.Location = New System.Drawing.Point(93, 20)
        Me.uxLocal.Name = "uxLocal"
        Me.uxLocal.Size = New System.Drawing.Size(51, 16)
        Me.uxLocal.TabIndex = 1
        Me.uxLocal.Text = "Local"
        Me.uxLocal.UseVisualStyleBackColor = True
        '
        'uxCentral
        '
        Me.uxCentral.AutoSize = True
        Me.uxCentral.Checked = True
        Me.uxCentral.Font = New System.Drawing.Font("Verdana", 7.25!)
        Me.uxCentral.Location = New System.Drawing.Point(10, 20)
        Me.uxCentral.Name = "uxCentral"
        Me.uxCentral.Size = New System.Drawing.Size(63, 16)
        Me.uxCentral.TabIndex = 0
        Me.uxCentral.TabStop = True
        Me.uxCentral.Text = "Central"
        Me.uxCentral.UseVisualStyleBackColor = True
        '
        'Chkpublish
        '
        ...
        Me.ldate.Margin = New System.Windows.Forms.Padding(3, 3, 3, 0)
        Me.ldate.Name = "ldate"
        Me.ldate.Size = New System.Drawing.Size(257, 70)
        ...
        Me.FilterDateTo.Location = New System.Drawing.Point(48, 43)
        ...
        Me.FilterDateFrom.Location = New System.Drawing.Point(48, 18)
        ...
        Me.pdateto.Location = New System.Drawing.Point(233, 43)
        ...
        Me.pdatefrom.Location = New System.Drawing.Point(233, 18)
        ...
        Me.uxDocumentSource.ResumeLayout(False)
        Me.uxDocumentSource.PerformLayout()
...
#End Region
                ...
                For j = 0 To bc_am_workflow.ofrm.DocumentList.Items(i).SubItems.Count - 1
                    If InStr(bc_am_workflow.ofrm.DocumentList.Items(i).SubItems(j).Text, search_str, CompareMethod.Text) > 0 Then
                        ...
                        For k = 0 To bc_am_workflow.docs.document.Count - 1
                            ...
                            If CStr(bc_am_workflow.docs.document(k).id) = bc_am_workflow.ofrm.DocumentList.Items(i).SubItems(1).Text _
                                 Or bc_am_workflow.docs.document(k).filename = bc_am_workflow.ofrm.DocumentList.Items(i).SubItems(1).Text Then
    ...
    Private Sub MenuItem7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DisplayMenu_Refresh.Click
        ...
        'If uxLocal.Checked = True And isInitialised = True Then
        '    loadLocalDocuments()
        'Else
    ...
    Public Sub new_load_authors()
        ...
        If bc_am_workflow.sauthor_id.Count = 0 Then
            t1.all = True
        End If
        If bc_cs_central_settings.generic_filter = False Then
        ...
        Else
            For i = 0 To bc_am_workflow.lauthor.Count - 1
                For j = 0 To bc_am_load_objects.obc_entities.entity.Count - 1
                    If bc_am_workflow.lauthor(i) = bc_am_load_objects.obc_entities.entity(j).id Then
                        Dim t2 As New taxonomy_Item
                        t2.id = bc_am_load_objects.obc_entities.entity(j).id
                        t2.name = bc_am_load_objects.obc_entities.entity(j).name
                        t2.selected = False
    ...
    Private Sub pdatefrom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pdatefrom.Click
        If bc_am_workflow.fdatefrom = "9-9-9999" Then
            ...
            owf.retrieve_docs(False)
        Else
            If Chkpublish.Checked = False Then
                Me.pdatefrom.Image = Me.CheckBoxImages.Images(CHECK_OFF_2)
    ...
    Private Sub Chkpublish_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chkpublish.CheckedChanged
        ...
        If state = Me.Chkpublish.Checked Then
            Exit Sub
        End If

        If Me.Chkpublish.Checked = True Then
            If Me.FilterDateFrom.Visible = True Then
                state = True
    ...
    Private Sub uxLocal_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles uxLocal.CheckedChanged

        If uxLocal.Checked = True And isInitialised = True Then

            ImportMenu_MasteDocument.Enabled = False
            ImportMenu_SupportDoc.Enabled = False
            mreattach.Enabled = False
            mregdoc.Enabled = False
    ...
    Private Sub uxCentral_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles uxCentral.CheckedChanged

        If uxCentral.Checked = True And isInitialised = True Then

            Me.ImportMenu_MasteDocument.Enabled = True
            Me.mregdoc.Enabled = True
    ...
    Private Sub loadLocalDocuments()
        REM steve wooderson 08/07/2013 local docs
        REM display local documents

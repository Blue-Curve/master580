...
#End Region
    ...
    Public Function Initialize(ByVal ao_object As Object, ByVal ao_type As String) As Boolean
        ...
        Try
            ...
            For i = 0 To ldoc.support_documents.Count - 1
                addToListView(ldoc.support_documents(i))
            Next
        ...
        Try
            ...
            For i = 0 To ldoc.support_documents.Count - 1
                If SupportingDocsList.SelectedItems(0).SubItems(1).Text <> "0" Then
                    If SupportingDocsList.SelectedItems(0).SubItems(1).Text = CStr(ldoc.support_documents(i).id) Then
                        Me.docComment.Text = ldoc.support_documents(i).summary
                ...
                End If
                If SupportingDocsList.SelectedItems(0).SubItems(1).Text = "0" Then
                    If SupportingDocsList.SelectedItems(0).SubItems(0).Text = CStr(ldoc.support_documents(i).title) Then
                        Me.docComment.Text = ldoc.support_documents(i).summary
                        Exit For
                    End If
    ...
    Private Sub ViewSupportDoc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ViewSupportDoc.Click
        ...
        For i = 0 To ldoc.support_documents.Count - 1
            If SupportingDocsList.SelectedItems(0).SubItems(1).Text <> "0" Then
                If SupportingDocsList.SelectedItems(0).SubItems(1).Text = CStr(ldoc.support_documents(i).id) Then
                    owf.look_at_support_doc(ldoc.support_documents(i).id, ldoc)
                    Exit For
                End If
            ...
            If SupportingDocsList.SelectedItems(0).SubItems(1).Text = "0" Then
                If SupportingDocsList.SelectedItems(0).SubItems(0).Text = CStr(ldoc.support_documents(i).title) Then
                    ext = ldoc.support_documents(i).extension

                    fn = owf.save_view_only_file(ldoc.support_documents(i))
                    If fn <> "" Then
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnset.Click
        ...
        For i = 0 To ldoc.support_documents.Count - 1
            If SupportingDocsList.SelectedItems(0).SubItems(1).Text = "0" Then
                If SupportingDocsList.SelectedItems(0).SubItems(0).Text = CStr(ldoc.support_documents(i).title) Then
                    ldoc.support_documents(i).summary = Me.docComment.Text
                    Me.btnset.Enabled = False
                    Exit For
                End If

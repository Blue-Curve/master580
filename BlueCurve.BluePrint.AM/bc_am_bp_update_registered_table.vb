Public Class bc_am_bp_update_registered_table
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents uxAutoTxtName As System.Windows.Forms.Label
    Friend WithEvents uxAutoTextName As System.Windows.Forms.TextBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(bc_am_bp_update_registered_table))
        Me.uxDetails = New System.Windows.Forms.GroupBox()
        Me.uxAutoTxtName = New System.Windows.Forms.Label()
        Me.uxAutoTextName = New System.Windows.Forms.TextBox()
        ...
        'uxDetails
        '
        Me.uxDetails.Controls.Add(Me.uxAutoTxtName)
        Me.uxDetails.Controls.Add(Me.uxAutoTextName)
        ...
        Me.uxDetails.Location = New System.Drawing.Point(4, -1)
        Me.uxDetails.Name = "uxDetails"
        Me.uxDetails.Size = New System.Drawing.Size(488, 97)
        Me.uxDetails.TabIndex = 0
        Me.uxDetails.TabStop = False
        '
        'uxAutoTxtName
        '
        Me.uxAutoTxtName.Location = New System.Drawing.Point(8, 40)
        Me.uxAutoTxtName.Name = "uxAutoTxtName"
        Me.uxAutoTxtName.Size = New System.Drawing.Size(84, 23)
        Me.uxAutoTxtName.TabIndex = 4
        Me.uxAutoTxtName.Text = "Autotext Name:"
        '
        'uxAutoTextName
        '
        Me.uxAutoTextName.Location = New System.Drawing.Point(96, 37)
        Me.uxAutoTextName.MaxLength = 32
        Me.uxAutoTextName.Name = "uxAutoTextName"
        Me.uxAutoTextName.Size = New System.Drawing.Size(388, 20)
        Me.uxAutoTextName.TabIndex = 1
        '
        'uxTblName
        '
        ...
        'uxTableName
        '
        Me.uxTableName.Location = New System.Drawing.Point(96, 12)
        Me.uxTableName.MaxLength = 32
        Me.uxTableName.Name = "uxTableName"
        Me.uxTableName.Size = New System.Drawing.Size(388, 20)
        Me.uxTableName.TabIndex = 0
        '
        'uxCancel
        '
        ...
        Me.uxCancel.Location = New System.Drawing.Point(408, 66)
        ...
        Me.uxOK.Location = New System.Drawing.Point(328, 66)
        Me.uxOK.Name = "uxOK"
        ...
        Me.uxFooterPanel.Location = New System.Drawing.Point(0, 100)
        Me.uxFooterPanel.Name = "uxFooterPanel"
        Me.uxFooterPanel.Size = New System.Drawing.Size(494, 64)
        Me.uxFooterPanel.TabIndex = 3
        '
        'uxServer
        '
        ...
        Me.uxServer.Location = New System.Drawing.Point(244, 24)
        ...
        Me.uxRole.Location = New System.Drawing.Point(368, 4)
        ...
        Me.uxUser.Location = New System.Drawing.Point(244, 4)
        ...
        '
        'bc_am_bp_update_registered_table
        '
        Me.AcceptButton = Me.uxOK
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.BackColor = System.Drawing.Color.White
        Me.CancelButton = Me.uxCancel
        Me.ClientSize = New System.Drawing.Size(494, 164)
        ...
        Me.Name = "bc_am_bp_update_registered_table"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent
        Me.Text = "Update Registered Table"
...
#End Region
    ...
    Private Sub uxTableName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles uxTableName.TextChanged
        ...
        If (Trim(uxTableName.Text) = "" OrElse uxTableName.Text.StartsWith("0") OrElse _
            ...
            uxTableName.Text.StartsWith("9") OrElse uxTableName.Text.StartsWith("_")) Or _
            (Trim(uxAutoTextName.Text) = "" OrElse uxAutoTextName.Text.StartsWith("0") OrElse _
            uxAutoTextName.Text.StartsWith("1") OrElse uxAutoTextName.Text.StartsWith("2") OrElse _
            uxAutoTextName.Text.StartsWith("3") OrElse uxAutoTextName.Text.StartsWith("4") OrElse _
            uxAutoTextName.Text.StartsWith("5") OrElse uxAutoTextName.Text.StartsWith("6") OrElse _
            uxAutoTextName.Text.StartsWith("7") OrElse uxAutoTextName.Text.StartsWith("8") OrElse _
            uxAutoTextName.Text.StartsWith("9") OrElse uxAutoTextName.Text.StartsWith("_")) Then
            uxOK.Enabled = False
        Else
            uxOK.Enabled = True
        End If
    ...
    Private Sub uxAutoTextName_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles uxAutoTextName.TextChanged

        If (Trim(uxAutoTextName.Text) = "" OrElse uxAutoTextName.Text.StartsWith("0") OrElse _
            uxAutoTextName.Text.StartsWith("1") OrElse uxAutoTextName.Text.StartsWith("2") OrElse _
            uxAutoTextName.Text.StartsWith("3") OrElse uxAutoTextName.Text.StartsWith("4") OrElse _
            uxAutoTextName.Text.StartsWith("5") OrElse uxAutoTextName.Text.StartsWith("6") OrElse _
            uxAutoTextName.Text.StartsWith("7") OrElse uxAutoTextName.Text.StartsWith("8") OrElse _
            uxAutoTextName.Text.StartsWith("9") OrElse uxAutoTextName.Text.StartsWith("_")) Or _
            (Trim(uxTableName.Text) = "" OrElse uxTableName.Text.StartsWith("0") OrElse _
            uxTableName.Text.StartsWith("1") OrElse uxTableName.Text.StartsWith("2") OrElse _
            uxTableName.Text.StartsWith("3") OrElse uxTableName.Text.StartsWith("4") OrElse _
            uxTableName.Text.StartsWith("5") OrElse uxTableName.Text.StartsWith("6") OrElse _
            uxTableName.Text.StartsWith("7") OrElse uxTableName.Text.StartsWith("8") OrElse _
    ...
    Private Sub uxAutoTextName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles uxAutoTextName.KeyPress

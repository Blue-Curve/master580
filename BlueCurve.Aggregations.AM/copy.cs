...
//                //log_activity = new calcs_error_activity("class_calc_template", "run_template_batch", "Started db seal: " + template_id.ToString(), false, ref certificate, template_id, 0, 0, 0);
//                //timings.Add(log_activity);
...
//                //sql_params.Add(sql_param);
//                //gdb.executesql_with_parameters_no_timeout("bc_core_calcs_services_seal_data", sql_params, ref certificate);


//                //bulkdatainsert md = new bulkdatainsert();
//                //log_activity = new calcs_error_activity("class_calc_template", "run_template_batch", "Started db write: " + template_id.ToString() , false, ref certificate, template_id, 0, 0, 0);
//                //timings.Add(log_activity);
//                //md.BulkInsertEPTEAVTS(alltemplateresults, template_id, 0, ref certificate, ref errors);
//                //log_activity = new calcs_error_activity("class_calc_template", "run_template_batch", "End db write: " + template_id.ToString() , false, ref certificate, template_id, 0, 0, 0);
//                //timings.Add(log_activity);


//                //log_activity = new calcs_error_activity("class_calc_template", "run_template", "All batches for template" + template_id.ToString() + "Complete.", false, ref certificate, template_id, 0, 0, 0);
//                //timings.Add(log_activity);
...
//                {
//                    calc_template_batch(is_parent, ref  allresults, batch_num, template_calc_batches[i].type, template_calc_batches[i].order, entity_period_tbl, entity_period_tbl_info);
//                }
//                //write results to db
...
//                {
//                    alltemplateresults.Add(allresults[i]);
//                }
//                //bulkdatainsert md = new bulkdatainsert();
...
//            }
//        }
//        void calc_template_batch(bool is_parent, ref List<db_entity_period_tbl> allresults, int batch_id, int calc_type, int calc_order, List<db_entity_period_tbl> entity_period_tbl, List<entity_info> entity_period_tbl_info)
//        {
//            try
//            {
...
//                    if (calcs.Count > 0)
//                    {
//                        assign_normal(is_parent, calcs, entity_period_tbl, allresults, ref stagenormal, batch_id, calc_type, calc_order);
//                    }
...
//                    if (calcs.Count > 0)
//                    {
//                        assign_cc(calcs, entity_period_tbl, allresults, ref stagecc, batch_id, calc_type, calc_order);
//                    }
...
//                    if (calcs.Count > 0)
//                    {
//                        assign_mom(calcs, entity_period_tbl, allresults, ref stagemom, batch_id, calc_type, calc_order);
//                    }
//                }
//                else
//                {
...
//                    if (calcs.Count > 0)
//                    {
//                        assign_growths(calcs, entity_period_tbl, allresults, ref stagegrowths, batch_id, calc_type, calc_order);
//                    }
...
//                        assign_to_results(true, lcalculationsnormal[i], ref allresults, lresults, null, audit_id, contributor_id, audit_date, false, template_id, batch_id, calc_type, calc_order, lcalculationsnormal[i].calculation_id, lcalculationsnormal[i].historic, lcalculationsnormal[i].estimate, lcalculationsnormal[i].cumulative, lcalculationsnormal[i].static_to_period, entity_period_tbl_info);
...
//                                 where ((v.row_id != item_id) || (v.row_id == item_id && v.e_a_flag == true))
//                                 select new db_entity_period_tbl
//                                 {
//                                     value = v.value,
//                                     dvalue = v.dvalue,
...
//                {
//                    var cquery = from v in allresults
//                                 where ((v.row_id != item_id) || (v.row_id == item_id && v.e_a_flag == false))
//                                 select new db_entity_period_tbl
//                                 {
//                                     value = v.value,
//                                     dvalue = v.dvalue,
...
//        void assign_normal(bool is_parent, List<abc_calc> calcs, List<db_entity_period_tbl> entity_period_tbl, List<db_entity_period_tbl> allresults, ref List<abc_calc> stage, int batch_id, int calc_type, int calc_order)
//        {
//            try
//            {
...
//                            equals new { j12 = s.interval_type, j1 = s.row_id, j3 = s.entity_id, j4 = s.year, j5 = s.period_id, j6 = s.contributor_id, j8 = s.workflow_stage } into ss
//                            from s in ss.DefaultIfEmpty()

//                            join t in allresults on new { j1 = v.operand_1_id, j3 = v.entity_id, j4 = v.year, j5 = v.period_id, j6 = v.contributor_id, j8 = v.workflow_stage }
//                            equals new { j1 = t.row_id, j3 = t.entity_id, j4 = t.year, j5 = t.period_id, j6 = t.contributor_id, j8 = t.workflow_stage } into ts
//                            from t in ts.DefaultIfEmpty()
//                            where v.operand_1_id != 0
//                            select new abc_calc
//                            {
//                                value_1 = (t == null ? (s == null ? null : s.dvalue) : t.dvalue),
...
//                        join t in allresults on new { j1 = v.operand_2_id, j3 = v.entity_id, j4 = v.year, j5 = v.period_id, j6 = v.contributor_id, j8 = v.workflow_stage }
//                              equals new { j1 = t.row_id, j3 = t.entity_id, j4 = t.year, j5 = t.period_id, j6 = t.contributor_id, j8 = t.workflow_stage } into ts
//                        from t in ts.DefaultIfEmpty()
...
//                            value_2 = (t == null ? (s == null ? null : s.dvalue) : t.dvalue),
...
//                        join t in allresults on new { j1 = v.operand_3_id, j3 = v.entity_id, j4 = v.year, j5 = v.period_id, j6 = v.contributor_id, j8 = v.workflow_stage }
//                              equals new { j1 = t.row_id, j3 = t.entity_id, j4 = t.year, j5 = t.period_id, j6 = t.contributor_id, j8 = t.workflow_stage } into ts
//                        from t in ts.DefaultIfEmpty()
...
//                            value_3 = (t == null ? (s == null ? null : s.dvalue) : t.dvalue),
...
//                        join t in allresults on new { j1 = v.operand_4_id, j3 = v.entity_id, j4 = v.year, j5 = v.period_id, j6 = v.contributor_id, j8 = v.workflow_stage }
//                              equals new { j1 = t.row_id, j3 = t.entity_id, j4 = t.year, j5 = t.period_id, j6 = t.contributor_id, j8 = t.workflow_stage } into ts
//                        from t in ts.DefaultIfEmpty()
...
//                            value_4 = (t == null ? (s == null ? null : s.dvalue) : t.dvalue),
...
//                        join t in allresults on new { j1 = v.operand_5_id, j3 = v.entity_id, j4 = v.year, j5 = v.period_id, j6 = v.contributor_id, j8 = v.workflow_stage }
//                              equals new { j1 = t.row_id, j3 = t.entity_id, j4 = t.year, j5 = t.period_id, j6 = t.contributor_id, j8 = t.workflow_stage } into ts
//                        from t in ts.DefaultIfEmpty()
...
//                            value_5 = (t == null ? (s == null ? null : s.dvalue) : t.dvalue),
...
//                        join t in allresults on new { j1 = v.operand_6_id, j3 = v.entity_id, j4 = v.year, j5 = v.period_id, j6 = v.contributor_id, j8 = v.workflow_stage }
//                              equals new { j1 = t.row_id, j3 = t.entity_id, j4 = t.year, j5 = t.period_id, j6 = t.contributor_id, j8 = t.workflow_stage } into ts
//                        from t in ts.DefaultIfEmpty()
...
//                            value_6 = (t == null ? (s == null ? null : s.dvalue) : t.dvalue),
...
//                        join t in allresults on new { j1 = v.operand_7_id, j3 = v.entity_id, j4 = v.year, j5 = v.period_id, j6 = v.contributor_id, j8 = v.workflow_stage }
//                              equals new { j1 = t.row_id, j3 = t.entity_id, j4 = t.year, j5 = t.period_id, j6 = t.contributor_id, j8 = t.workflow_stage } into ts
//                        from t in ts.DefaultIfEmpty()
...
//                            value_7 = (t == null ? (s == null ? null : s.dvalue) : t.dvalue),
...
//                        join t in allresults on new { j1 = v.operand_8_id, j3 = v.entity_id, j4 = v.year, j5 = v.period_id, j6 = v.contributor_id, j8 = v.workflow_stage }
//                              equals new { j1 = t.row_id, j3 = t.entity_id, j4 = t.year, j5 = t.period_id, j6 = t.contributor_id, j8 = t.workflow_stage } into ts
//                        from t in ts.DefaultIfEmpty()
...
//                            value_8 = (t == null ? (s == null ? null : s.dvalue) : t.dvalue),
...
//        void assign_growths(List<abc_calc> calcs, List<db_entity_period_tbl> entity_period_tbl, List<db_entity_period_tbl> allresults, ref List<abc_calc> stage, int batch_id, int calc_type, int calc_order)
//        {
//            try
//            {
...
//                            equals new { j10 = s.interval_type, j4 = s.year, j1 = s.row_id, j3 = s.entity_id, j5 = s.period_id, j6 = s.contributor_id, j8 = s.workflow_stage } into ss
...
//                   equals new { j10 = s.interval_type, j1 = s.row_id, j3 = s.entity_id, j4 = s.year, j5 = s.period_id, j6 = s.contributor_id, j8 = s.workflow_stage } into ss
//                        from s in ss.DefaultIfEmpty()
//                        join t in allresults on new { j1 = v.operand_1_id, j3 = v.entity_id, j4 = v.year, j5 = v.period_id, j6 = v.contributor_id, j8 = v.workflow_stage }
//                           equals new { j1 = t.row_id, j3 = t.entity_id, j4 = t.year, j5 = t.period_id, j6 = t.contributor_id, j8 = t.workflow_stage } into ts
//                        from t in ts.DefaultIfEmpty()
...
//            }
//        }
//        void assign_cc(List<abc_calc> calcs, List<db_entity_period_tbl> entity_period_tbl, List<db_entity_period_tbl> allresults, ref List<abc_calc> stage, int batch_id, int calc_type, int calc_order)
//        {
//            try
//            {
...
//            }
//        }
//        void assign_mom(List<abc_calc> calcs, List<db_entity_period_tbl> entity_period_tbl, List<db_entity_period_tbl> allresults, ref List<abc_calc> stage, int batch_id, int calc_type, int calc_order)
//        {
//            try
//            {
...
//                   equals new { j10 = s.interval_type, j1 = s.row_id, j3 = s.entity_id, j4 = s.year, j5 = s.period_id, j6 = s.contributor_id, j8 = s.workflow_stage } into ss
//                        from s in ss.DefaultIfEmpty()
//                        join t in allresults on new { j10 = v.default_interval_type, j1 = v.operand_2_id, j3 = v.entity_id, j4 = v.year, j5 = v.period_id, j6 = v.contributor_id, j8 = v.workflow_stage }
//                   equals new { j10 = t.interval_type, j1 = t.row_id, j3 = t.entity_id, j4 = t.year, j5 = t.period_id, j6 = t.contributor_id, j8 = t.workflow_stage } into ts
//                        from t in ts.DefaultIfEmpty()
...
//                                 select new db_entity_period_tbl
//                                 {
//                                     dvalue = v.value_1 == null || v.value_2 == null ? 0 : (decimal)(((decimal)Math.Pow(System.Convert.ToDouble(v.value_1) / System.Convert.ToDouble(v.current_price), 1.0 / System.Convert.ToDouble(v.value_2)) - 1) + (v.value_3 / v.currency_denominator) / (v.current_price / v.trading_denominator)),
//                                     entity_id = v.entity_id,
//                                     row_id = v.result_row_id,
//                                     year = v.year,
//                                     period_id = v.period_id,

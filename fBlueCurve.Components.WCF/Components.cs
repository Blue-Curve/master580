...
namespace bc_core_components_svc
{
   ...
   // [ServiceContract]
    ...
    public interface IComponentsService
    {
        ...
        [OperationContract]
        string GetJsonForBCComponent(long entity_id, int type, long stage_id = 8, long contributor_id = 1, long user_id = 0, long language_id = 0, DateTime data_at_date = default(DateTime), long pub_type_id = 0, List<bc_core_component_parameter> parameters=null);
    ...
    public class bc_core_component
    {
        ...
        long _pub_type_id=0;
        List <bc_core_component_parameter> _parameters;
        ...
        [DataMember]
        public List <bc_core_component_parameter> parameters
        {

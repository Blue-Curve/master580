...
namespace bc_core_components_svc
{
    ...
    public class ComponentsService : IComponentsService
    {
        ...
        public string GetJsonForBCComponent(long entity_id, int type, long stage_id = 8, long contributor_id = 1, long user_id = 0, long language_id = 1, DateTime data_at_date = default(DateTime), long pub_type_id = 0, bc_core_component_parameters parameters = null)
        {
        ...
        public string GetJson(bc_component_mode mode, long entity_id, int type, long doc_id = 0, long comp_id = 0, long template_id = 0, string locator = "", long stage_id = 8, long contributor_id = 1, long user_id = 0, long language_id = 1, DateTime data_at_date = default(DateTime), long pub_type_id = 0, bc_core_component_parameters parameters = null)
        {
            try
            {
                bc_cs_central_settings bcs = new bc_cs_central_settings(true);
                ...
                if (certificate.error_state == false)
                {
                    ...
                    if (certificate.error_state == false)
                    {
                        ...
                        return ct.translate_table_to_JSON(res);
                    }
                    else
                        return certificate.server_errors[0].ToString();
                }

...
Public Class bc_am_in_universe_builder
    ...
    Friend btnNew, btnDelete, btnSave, btnCancel, btnCalculations, btnactive, btnexclusions, bthhier, btncalclib As ToolBarButton
    ...
    Private Sub lvAggregations_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvAggregations.SelectedIndexChanged
        If lvAggregations.SelectedItems.Count = 0 Then
            ...
            Me.btnexclusions.Enabled = False
            Me.bthhier.Enabled = False
        ...
        btnexclusions.Enabled = True
        Me.bthhier.Enabled = False
        If Me.cbTargetClass.SelectedIndex > -1 And Me.cbtargetclass2.SelectedIndex > -1 Then
            Me.bthhier.Enabled = True
        End If
                ...
                For i = 0 To classes.attribute_pool.Count - 1
                    If classes.attribute_pool(i).attribute_id = boav.attribute_Id Then
                        ...
                        If classes.attribute_pool(i).name = "List Formula" Then
                            ...
                            boav.value_changed = True
                        End If
                        If classes.attribute_pool(i).name = "Consolidate first" Then
                            boav.value = 0
                            If Ccalenderized.Checked = True Then
                                boav.value = 1
                            End If
                            boav.value_changed = True
                        End If
                        If classes.attribute_pool(i).name = "Store consolidated source" Then
                            boav.value = 0
                            If csource.Checked = True Then
                                boav.value = 1
                            End If
                            boav.value_changed = True
                        End If
                        If classes.attribute_pool(i).name = "Use Local Currency" Then
                            boav.value = 0
            ...
            For Each boav As bc_om_attribute_value In boeAggregation.attribute_values
                ...
                For i = 0 To classes.attribute_pool.Count - 1
                    If classes.attribute_pool(i).attribute_id = boav.attribute_Id Then
                        ...
                        End If
                        If classes.attribute_pool(i).name = "Consolidate first" Then
                            If boav.value = "1" Then
                                Me.Ccalenderized.Checked = True
                            Else
                                Me.Ccalenderized.Checked = False
                            End If
                        End If
                        If classes.attribute_pool(i).name = "Store consolidated source" Then
                            If boav.value = "1" Then
                                Me.csource.Checked = True
                            Else
                                Me.csource.Checked = False
                            End If
                        End If
                        If classes.attribute_pool(i).name = "Use Local Currency" Then
                            If boav.value = "1" Then
    ...
    Private Sub btnPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreview.Click
        ...
        Try
            If bc_cs_central_settings.aggregation_system_url <> "" Then
                Dim f As New bc_dx_agg_preview
                Dim c As New Cbc_am_aggs_preview
                Cursor = Cursors.WaitCursor
                If c.load_data(f, boeAggregation.id) = True Then
    ...
    Private Sub loadPreview_first()
        ...
        Dim exch_type As Int16
        Dim sexch_type As String = ""
        ...
        If IsArray(gpreview_results) Then
            ...
            Else
                ...
                For i As Integer = 0 To gpreview_results.GetUpperBound(1)
                    ...
                    If Not gpreview_results(16, i) Is DBNull.Value Then
                        exch_type = gpreview_results(16, i)
                    End If
                    If Not gpreview_results(17, i) Is DBNull.Value Then
                        str(4) = gpreview_results(17, i)
                    End If

                    If Not gpreview_results(18, i) Is DBNull.Value Then
                        str(6) = gpreview_results(18, i)
                    End If
                    ...
                    ElseIf exch_type = 1 Then
                        sexch_type = "Period End"

                    ElseIf exch_type = 2 Then
                        sexch_type = "Period Average"
                    End If
                    found = False
                    For j = 0 To Me.cexchtype.Items.Count - 1
                        If Me.cexchtype.Items(j) = sexch_type Then
                            found = True
                        End If
                    Next
                    If found = False Then
                        Me.cexchtype.Items.Add(sexch_type)
                    End If
            ...
            Me.cexchtype.SelectedIndex = 0
            If Me.cexchtype.Items.Count = 2 Then
                Me.cexchtype.SelectedIndex = 1
            ElseIf Me.cexchtype.Items.Count > 2 Then
                Me.cexchtype.Enabled = True
            End If
        ...
        Try
            ...
            If IsArray(gpreview_results) Then
                ...
                For i As Integer = 0 To gpreview_results.GetUpperBound(1)
                    ...
                    And (Me.cbPreviewContributor.SelectedIndex = 0 Or Me.cbPreviewContributor.Text = str(6)) _
                    And (Me.cexchtype.SelectedIndex = 0 Or Me.cexchtype.Text = sexch_type) Then
    ...
    Private Sub cbSourceClass_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbSourceClass.SelectedIndexChanged
        ...
        Try
            Me.cbTargetClass.Enabled = False
            Me.cbTargetClass.SelectedIndex = -1
            bc_am_calculation_values.source_class_Id = 0
            If cbType.SelectedIndex = 1 Then
                ...
                For i = 0 To classes.classes.Count - 1
                    If classes.classes(i).class_name = cbSourceClass.Text And (classes.classes(i).class_type_id = 1 Or classes.classes(i).class_type_id = 4) Then
                        bc_am_calculation_values.source_class_id = classes.classes(i).class_id
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            If bc_cs_central_settings.aggregation_system_url <> "" Then
                ...
                bsql.exec_sql("exec dbo.bc_core_aggs_services_preview_run " + CStr(boeAggregation.id), bc_cs_sql.SQL_TYPE.NO_TIMEOUT, Nothing)
                Exit Sub
            End If
        ...
        For j = 0 To results.Count - 1
            For i = 0 To lAggregations.Count - 1
                If lAggregations(i).name = results(j) Then
                    ...
                    'If entities.entity(i).inactive = True Then
                    If lAggregations(i).inactive = True Then
                        lv.SubItems.Add("no")
                    Else
                        lv.SubItems.Add("yes")
                    End If
    ...
    Private Sub cbTargetClass_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbTargetClass.SelectedIndexChanged
        ...
        Me.cbtargetclass2.SelectedIndex = -1
        Me.bthhier.Enabled = False
        bc_am_calculation_values.target_class_id = 0

        If cbTargetClass.SelectedIndex > -1 Then
            Me.cbtargetclass2.Enabled = True
            For i = 0 To classes.classes.Count - 1
                If classes.classes(i).class_name = cbTargetClass.Text Then
                    bc_am_calculation_values.target_class_id = classes.classes(i).class_id
                    Exit For
                End If
            Next
        End If
    ...
    Private Sub cexchtype_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cexchtype.SelectedIndexChanged
        loadPreview()
    End Sub

    Private Sub cbtargetclass2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbtargetclass2.SelectedIndexChanged
        Me.bthhier.Enabled = False
        If Me.cbTargetClass.SelectedIndex > -1 And Me.cbtargetclass2.SelectedIndex > -1 Then
            Me.bthhier.Enabled = True
            bc_am_calculation_values.source_class_id = 0
    ...
    Private Sub Bc_am_calc_search1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Bc_am_calc_search1.Load

    End Sub

    Private Sub Ccalenderized_CheckedChanged(sender As Object, e As EventArgs) Handles Ccalenderized.CheckedChanged
        If Ccalenderized.Checked = True Then
            Me.csource.Checked = False
            Me.csource.Enabled = False
        Else
            Me.csource.Enabled = True
        End If
    End Sub

    Private Sub cbNumberOfYears_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbNumberOfYears.SelectedIndexChanged

    End Sub

    Private Sub csource_CheckedChanged(sender As Object, e As EventArgs) Handles csource.CheckedChanged

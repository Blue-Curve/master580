...
Public Class bc_am_in_tk_item
    ...
    Friend WithEvents ccurrtype As System.Windows.Forms.ComboBox
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ccurrtype = New System.Windows.Forms.ComboBox()
        ...
        Me.Cexist.Location = New System.Drawing.Point(76, 34)
        ...
        Me.uxItems.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.uxItems.Controls.Add(Me.Label1)
        Me.uxItems.Controls.Add(Me.ccurrtype)
        ...
        Me.Label1.Text = "Curr Type:"
        '
        'ccurrtype
        '
        Me.ccurrtype.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.ccurrtype.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.ccurrtype.FormattingEnabled = True
        Me.ccurrtype.Location = New System.Drawing.Point(76, 63)
        Me.ccurrtype.Name = "ccurrtype"
        Me.ccurrtype.Size = New System.Drawing.Size(136, 21)
        Me.ccurrtype.TabIndex = 82
        '
        'Label8
        '
        ...
        Me.tlabel.Location = New System.Drawing.Point(76, 34)
        ...
        Me.rexist.Location = New System.Drawing.Point(76, 9)
        Me.rexist.Name = "rexist"
        Me.rexist.Size = New System.Drawing.Size(80, 24)
        ...
        Me.rnew.Location = New System.Drawing.Point(7, 13)
        Me.rnew.Name = "rnew"
        Me.rnew.Size = New System.Drawing.Size(64, 17)
        Me.rnew.TabIndex = 0
        Me.rnew.Text = "New"
        ...
        Me.lval.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.lval.Columns.AddRange(New System.Windows.Forms.ColumnHeader() {Me.ColumnHeader10, Me.ColumnHeader1})
...
#End Region
        ...
        Try
            ...
            If cdatatype.Text = "Output" Then
                ...
                For i = 0 To Me.lval.Items.Count - 1
                    Me.lval.Items(i).SubItems(1).Text = "none"
                Next
    ...
    Private Sub check_apply()
        ...
        If Me.ccurrtype.SelectedIndex = -1 Then
            Exit Sub
        End If
        ...
        For i = 0 To Me.lval.Items.Count - 1
            If LCase(Me.lval.Items(i).Text) = "look up" Then
                If Me.tlookup.Text <> "" Then
                    Me.lval.Items(i).SubItems(1).Text = "set"
                Else
                    Me.lval.Items(i).SubItems(1).Text = "none"
                End If
                Exit For
    ...
    Private Sub lval_Click(sender As Object, e As EventArgs) Handles lval.Click

        Dim tx As String
        tx = lval.SelectedItems(0).SubItems(1).Text
        If lval.SelectedItems(0).SubItems(0).Text = "Look Up" Then
            If tx = "none" Then
                lval.SelectedItems(0).SubItems(1).Text = "set"
            Else
                lval.SelectedItems(0).SubItems(1).Text = "none"
            End If
        Else

            If tx = "none" Then
                lval.SelectedItems(0).SubItems(1).Text = "error"
            ElseIf tx = "error" Then
                lval.SelectedItems(0).SubItems(1).Text = "warning"
            Else
                lval.SelectedItems(0).SubItems(1).Text = "none"
            End If
        End If
    ...
    Private Sub Cexist_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cexist.SelectedIndexChanged
        ...
        If Me.Cexist.SelectedIndex <> -1 Then
            ...
            End If
        End If
        Me.ccurrtype.SelectedIndex = bc_am_in_context.filter_insight_items.insight_items(Me.Cexist.SelectedIndex).monetary
        REM ====
    ...
    Private Sub cmon_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        check_apply()
    End Sub

    Private Sub Cprice_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        check_apply()
    End Sub

    Private Sub ccurrtype_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ccurrtype.SelectedIndexChanged
        check_apply()
    End Sub
End Class

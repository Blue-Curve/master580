...
#End Region
    ...
    Private Function build_function() As String
        Try
            ...
            Dim eti As String
            Dim tm As String
            Dim no_formula As Boolean = False
            eti = ""
            sti = ""
            fm = ""
            dims = ""
            For i = 0 To bc_am_ef_functions.excel_functions.Count - 1
                ...
                If bc_am_ef_functions.excel_functions(i).display_name = Me.Cfunction.Text Then
                    ...
                    For j = 0 To bc_am_ef_functions.excel_functions(i).params.count - 1
                        ...
                        If bc_am_ef_functions.excel_functions(i).params(j).name = "period" Then
                            no_formula = False
                            If Len(Cperiod.Text) > 2 Then
                                If Cperiod.Text.Substring(0, 1) = """" And Cperiod.Text.Substring(Cperiod.Text.Length - 1, 1) = """" Then
                                    no_formula = True
                                End If
                            End If
                            ti = Me.Cperiod.Text
            ...
            build_function = fm
        Catch ex As Exception
            Dim oerr As New bc_cs_error_log("bc_am_ef_wizard", "build_function", bc_cs_error_codes.USER_DEFINED, "Error building function: " + ex.Message)
    ...
    Private Sub check_calendar()
        disable_calendar()
        If Me.Cyear.Enabled = True And Me.Cperiod.Enabled = True And (Me.Cperiod.Text = """Full Year""" Or Me.Cperiod.Text = "Full Year" Or is_formula(Me.Cperiod.Text) = True) Then
            enable_calendar()
        End If
    ...
    Private Sub resizeForm()
        ...
        Catch ex As Exception
            ...
            Dim oerr As New bc_cs_error_log("bc_am_ef_wizard", "resize_form", bc_cs_error_codes.USER_DEFINED, ex.Message)
    ...
    Private Sub Cgen2_ChangeUICues(ByVal sender As Object, ByVal e As System.Windows.Forms.UICuesEventArgs) Handles Cgen2.ChangeUICues

...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents tenabledisable As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.tenabledisable = New System.Windows.Forms.TextBox()
        ...
        Me.universe = CType(New System.Windows.Forms.ColumnHeader(), System.Windows.Forms.ColumnHeader)
        ...
        Me.lsheets.Size = New System.Drawing.Size(264, 30)
        ...
        Me.tacccode.Location = New System.Drawing.Point(663, 57)
        ...
        'tenabledisable
        '
        Me.tenabledisable.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.tenabledisable.Location = New System.Drawing.Point(204, 124)
        Me.tenabledisable.Name = "tenabledisable"
        Me.tenabledisable.Size = New System.Drawing.Size(112, 21)
        Me.tenabledisable.TabIndex = 18
        Me.ToolTip1.SetToolTip(Me.tenabledisable, "Code used in client worksheets to depict row that the Period is stored in.")
        '
        'ColumnHeader4
        '
        ...
        Me.uxLinkCodes.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.uxLinkCodes.Controls.Add(Me.tenabledisable)
        Me.uxLinkCodes.Controls.Add(Me.Label17)
        ...
        Me.Label17.Location = New System.Drawing.Point(22, 124)
        Me.Label17.Name = "Label17"
        Me.Label17.Size = New System.Drawing.Size(139, 24)
        Me.Label17.TabIndex = 17
        Me.Label17.Text = "Enable Disable Code"
        '
        'Label11
        '
        ...
        Me.uxAggAudit.Size = New System.Drawing.Size(845, 286)
        ...
        Me.uxListAggAudit.Size = New System.Drawing.Size(833, 196)
...
#End Region
    ...
    Public Sub create_xml_file(Optional ByVal show_message As Boolean = True, Optional ByVal upload_to_server As Boolean = True)
        ...
        sxml = sxml + "<enable_disable>" + Me.tenabledisable.Text + "</enable_disable>" + vbCrLf
    ...
    Public Sub load_settings()
        ...
        Try
            ...
            Try
                Me.tenabledisable.Text = bc_am_insight_link_names.enable_disable
    ...
    Private Sub uxRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles uxRefresh.Click
        ...
        Try
            ...
            Me.Cursor = Cursors.WaitCursor
            Dim agg_details As New bc_om_agg_audit_headers_List
            REM refresh items
             If bc_cs_central_settings.selected_conn_method = bc_cs_central_settings.ADO Then
                agg_details.db_read()
            Else
                agg_details.tmode = bc_cs_soap_base_class.tREAD
                If agg_details.transmit_to_server_and_receive(agg_details, True) = False Then
                    Exit Sub
                End If
            End If
            bc_am_in_context.insight_items.agg_audit_headers.Clear()
            For i = 0 To agg_details.headers.Count - 1
                bc_am_in_context.insight_items.agg_audit_headers.Add(agg_details.headers(i))
            Next
    ...
    Private Sub tenabledisable_TextChanged(sender As Object, e As EventArgs) Handles tenabledisable.TextChanged
        set_changes()
    End Sub
End Class

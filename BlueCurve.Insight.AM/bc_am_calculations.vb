...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.tformula.Location = New System.Drawing.Point(16, 321)
        Me.tformula.Name = "tformula"
        Me.tformula.ReadOnly = True
        Me.tformula.Size = New System.Drawing.Size(746, 71)
        ...
        Me.Panel1.Size = New System.Drawing.Size(778, 433)
        ...
        Me.lvCalculationsCopy.Size = New System.Drawing.Size(335, 180)
...
#End Region
                    ...
                    If Me.lvCalculationsCopy.Items(i).Checked = True Then
                        ...
                        For j = 0 To Me.lvCalculations.Items.Count - 1
                            If Me.lvCalculations.Items(j).Selected = True Then
                                ...
                                oc.contributor1_id = obc_calcs.calculations(j).contributor1_id
                                oc.contributor2_id = obc_calcs.calculations(j).contributor2_id
                                oc.interval_type = obc_calcs.calculations(j).interval_type
                                oc.interval = obc_calcs.calculations(j).interval
                                oc.weighting_attribute = obc_calcs.calculations(j).weighting_attribute
                                oc.cal_operands = obc_calcs.calculations(j).cal_operands
                                oc.cal_month_end = obc_calcs.calculations(j).cal_month_end
                                oc.standard_deviation = obc_calcs.calculations(j).standard_deviation


                                oc.na_tx = obc_calcs.calculations(j).na_tx

                                REM 5.6 add currency type of item
                                For k = 0 To bc_am_calculation_values.rows.Count - 1
                                    If bc_am_calculation_values.rows(k).item_id = oc.result_row_id Then
                                        oc.monetary = bc_am_calculation_values.rows(k).curr_type
                                        Exit For
                                    End If
                                Next
            ...
            Else
                For i = 0 To Me.lvCalculationsCopy.Items.Count - 1
                    If Me.lvCalculationsCopy.Items(i).Checked = True Then
                        ...
                        REM 5.6 add currency type of item
                        For k = 0 To bc_am_calculation_values.rows.Count - 1
                            If bc_am_calculation_values.rows(k).item_id = ocopy_calcs.calculations(i).result_row_id Then
                                ocopy_calcs.calculations(i).monetary = bc_am_calculation_values.rows(k).curr_type
                                Exit For
                            End If
                        Next

                        For k = 0 To bc_am_calculation_values.rows.Count - 1
                            If bc_am_calculation_values.rows(k).item_id = ocopy_calcs.calculations(i).num_years Then
                                ocopy_calcs.calculations(i).monetary2 = bc_am_calculation_values.rows(k).curr_type
                                Exit For
                            End If
                        Next
    ...
    End Sub
    REM FIL 5.2 Aug 2014
    REM class class link attributes
...
Public Class bc_am_calculation_values
    ...
    Public Shared target_class_id = 0
    Public Shared source_class_id = 0
    Public Shared link_attributes As New bc_om_class_link_attributes

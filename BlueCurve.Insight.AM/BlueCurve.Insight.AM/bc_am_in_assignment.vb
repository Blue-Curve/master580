...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.tasstmp.Location = New System.Drawing.Point(8, 21)
    ...
    Private Sub Lcclass_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Lcclass.SelectedIndexChanged
        Try
            ...
            If Me.tasstmp.TabPages.Count = 1 Then
                load_template_assignments(True, False)
            Else
                load_template_assignments(True, True)
            End If
        ...
        End Try
    End Sub
    Public Sub load_template_assignments(ByVal primary_flag As Boolean, ByVal child_entity As Boolean)
        Dim i, j As Integer
        Dim st As Integer
        Dim co As Integer
        ...
        Try
            ...
            Select Case Me.tasstmp.SelectedIndex
                Case 0
                    ...
                    If Me.tasstmp.TabPages.Count = 1 Then
                        Me.load_template_assignments(True, False)
                    Else
                        Me.load_template_assignments(True, True)
                    End If
                    If Me.Lcclass.SelectedItems(0).SubItems(3).Text() = "None" Then
                        Me.ToolTip1.SetToolTip(Me.lasstmp, "Assign Template that all  " + Me.Lcclass.SelectedItems(0).SubItems(0).Text() + "(s) will use")
                    Else
                ...
                Case 1
                    ...
                    Me.load_template_assignments(False, True)
                    If Me.Lcclass.SelectedItems(0).SubItems(3).Text() = "None" Then

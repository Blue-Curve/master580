...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.uxNavBarImages = New System.Windows.Forms.ImageList(Me.components)
        Me.uxToolBarImages = New System.Windows.Forms.ImageList(Me.components)
        Me.uxGenericListImages = New System.Windows.Forms.ImageList(Me.components)
        ...
        Me.Panel3.Size = New System.Drawing.Size(936, 64)
        ...
        Me.Label17.Size = New System.Drawing.Size(279, 24)
        Me.Label17.TabIndex = 41
        Me.Label17.Text = "© Blue Curve Limited. All rights reserved. "
        '
        'lconn
        '
        ...
        Me.ListView1.Size = New System.Drawing.Size(82, 478)
        ...
        Me.pmain.Name = "pmain"
        Me.pmain.Size = New System.Drawing.Size(851, 477)
...
#End Region
    ...
    Private Sub load_begin()
        Try
            ...
            Else
                Me.lconn.Text = "Connected via SOAP to: " + bc_cs_central_settings.soap_server
            End If
        ...
        Try
            ...
            If all = False Then
                If ocont.tasstmp.SelectedIndex = 0 Then
                    ...
                    'bc_am_in_context.insight_items.contributing_classes(ocont.Lcclass.SelectedItems(0).Index).child_class_id = 0
                    ...
                    If ocont.tasstmp.TabPages.Count = 1 Then
                        ocont.load_template_assignments(True, False)
                    Else
                        ocont.load_template_assignments(True, True)
                    End If
                Else
                    ...
                    ocont.load_template_assignments(False, True)
                End If
                Me.set_button_disabled(3)
            Else
                If ocont.tasstmp.SelectedIndex = 0 Then

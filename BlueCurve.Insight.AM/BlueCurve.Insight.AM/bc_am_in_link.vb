        ...
        Try
            ...
            Else
                ...
                If bc_am_load_objects.obc_om_insight_contribution_for_entity.insight_sheets.bc_om_insight_sheets(0).logical_template_Id <> optemplate Then
                    omessage = New bc_cs_message("Blue Curve insight", "Primary financial templates are not the same, cloning is not allowed", bc_cs_message.MESSAGE)
                    Exit Sub
                End If
                ...
                If bc_am_load_objects.obc_om_insight_contribution_for_entity.insight_sheets.bc_om_insight_sheets.Count - 1 <> onumchild Then
                    omessage = New bc_cs_message("Blue Curve insight", "Number of Child sheets doesnt match cannot clone.", bc_cs_message.MESSAGE)
                End If
                ...
                If onumchild > 0 Then
                    If bc_am_load_objects.obc_om_insight_contribution_for_entity.insight_sheets.bc_om_insight_sheets(1).logical_template_Id <> ostemplate Then
                        omessage = New bc_cs_message("Blue Curve insight", "Child financial templates are not the same cannot clone.", bc_cs_message.MESSAGE)
                        Exit Sub
                    End If
                End If
...
Public Class bc_am_recreate_workbook_metadata
    ...
    End Sub
    Public Function recreate() As Boolean
